...
<body class="pkp_page_{$requestedPage|escape|default:"index"} pkp_op_{$requestedOp|escape|default:"index"}{if $showingLogo} has_site_logo{/if}" dir="{$currentLocaleLangDir|escape|default:"ltr"}">
	...
	<div class="pkp_structure_page">
		...
		{* Header *}
		<header class="pkp_structure_head enhanced-header" id="headerNavigationContainer" role="banner">
			{* Skip to content nav links *}
			{include file="frontend/components/skipLinks.tpl"}

			<div class="pkp_head_wrapper enhanced-header-wrapper">
				...
				<nav class="pkp_site_nav_menu" aria-label="{translate|escape key="common.navigation.site"}">
					...
					<div class="pkp_navigation_primary_row">
						<div class="pkp_navigation_primary_wrapper">
							...
							{if $currentContext && $requestedPage !== 'search'}
								<div class="pkp_navigation_search_wrapper">
									<a href="{url page="search"}" class="pkp_search pkp_search_desktop enhanced-search-btn">
										<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
											<circle cx="11" cy="11" r="8"></circle>
											<path d="m21 21-4.35-4.35"></path>
										</svg>
										<span class="search-text">{translate key="common.search"}</span>
									</a>
								</div>
							{/if}
						...
						{* User navigation - moved to be a sibling of primary wrapper *}
