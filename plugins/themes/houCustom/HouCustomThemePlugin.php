...
/**
 * @file plugins/themes/houCustom/HouCustomThemePlugin.php
 *
 * Copyright (c) 2014-2021 Simon Fraser University
 * Copyright (c) 2003-2021 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class HouCustomThemePlugin
 *
 * @brief Hanoi Open University Custom Theme
 */

namespace APP\plugins\themes\houCustom;
...
class HouCustomThemePlugin extends \PKP\plugins\ThemePlugin
{
    /**
    ...
    public function init()
    {
        ...
        $this->addOption('typography', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.houCustom.option.typography.label'),
            'description' => __('plugins.themes.houCustom.option.typography.description'),
            'options' => [
                [
                    'value' => 'notoSans',
                    'label' => __('plugins.themes.houCustom.option.typography.notoSans'),
                ],
                [
                    'value' => 'notoSerif',
                    'label' => __('plugins.themes.houCustom.option.typography.notoSerif'),
                ],
                [
                    'value' => 'notoSerif_notoSans',
                    'label' => __('plugins.themes.houCustom.option.typography.notoSerif_notoSans'),
                ],
                [
                    'value' => 'notoSans_notoSerif',
                    'label' => __('plugins.themes.houCustom.option.typography.notoSans_notoSerif'),
                ],
                [
                    'value' => 'lato',
                    'label' => __('plugins.themes.houCustom.option.typography.lato'),
                ],
                [
                    'value' => 'lora',
                    'label' => __('plugins.themes.houCustom.option.typography.lora'),
                ],
                [
                    'value' => 'lora_openSans',
                    'label' => __('plugins.themes.houCustom.option.typography.lora_openSans'),
                ],
            ],
            'default' => 'notoSans',
        ]);
        ...
        $this->addOption('baseColour', 'FieldColor', [
            'label' => __('plugins.themes.houCustom.option.colour.label'),
            'description' => __('plugins.themes.houCustom.option.colour.description'),
            'default' => '#1E6292',
        ]);
        ...
        $this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
            ...
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.houCustom.option.showDescriptionInJournalIndex.option'),
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
            'label' => __('plugins.themes.houCustom.option.useHomepageImageAsHeader.label'),
            'description' => __('plugins.themes.houCustom.option.useHomepageImageAsHeader.description'),
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.houCustom.option.useHomepageImageAsHeader.option')
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('displayStats', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.houCustom.option.displayStats.label'),
            'options' => [
                [
                    'value' => 'none',
                    'label' => __('plugins.themes.houCustom.option.displayStats.none'),
                ],
                [
                    'value' => 'bar',
                    'label' => __('plugins.themes.houCustom.option.displayStats.bar'),
                ],
                [
                    'value' => 'line',
                    'label' => __('plugins.themes.houCustom.option.displayStats.line'),
                ],
            ],
            'default' => 'none',
        ]);
    ...
    {
        return __('plugins.themes.houCustom.name');
    }
    ...
    {
        return __('plugins.themes.houCustom.description');
    }
    ...
    public function getSwiperI18n(): string
    {
        return 'var pkpDefaultThemeI18N = ' . json_encode([
            'nextSlide' => __('plugins.themes.houCustom.nextSlide'),
            'prevSlide' => __('plugins.themes.houCustom.prevSlide'),
        ]);
    }
}
