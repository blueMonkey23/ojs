...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, [
    'version' => '4.5.5',
    'unifunc' => 'content_69670e1828bd85_23888862',
    ...
    function content_69670e1828bd85_23888862(Smarty_Internal_Template $_smarty_tpl)
    {
        ?>

<div <?php if ($_smarty_tpl->tpl_vars['FBV_id']->value) {?>id="<?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ $_smarty_tpl->tpl_vars['FBV_id']->value ]);?>
" <?php }?>class="section <?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ (($tmp = $_smarty_tpl->tpl_vars['FBV_class']->value ?? null) === null || $tmp === '' ? '' ?? null : $tmp) ]);?>
 <?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ (($tmp = $_smarty_tpl->tpl_vars['FBV_layoutInfo']->value ?? null) === null || $tmp === '' ? '' ?? null : $tmp) ]);?>
">
	<?php if ($_smarty_tpl->tpl_vars['FBV_label']->value) {?>
		...
		<?php if ($_smarty_tpl->tpl_vars['FBV_labelFor']->value) {?><label for="<?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ $_smarty_tpl->tpl_vars['FBV_labelFor']->value ]);?>
"><?php echo $_smarty_tpl->tpl_vars['FBV_labelTranslated']->value;
	...
	<?php if ($_smarty_tpl->tpl_vars['FBV_description']->value) {?><label class="description"><?php if ($_smarty_tpl->tpl_vars['FBV_translate']->value) {
	    echo call_user_func_array($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], [ ['key' => $_smarty_tpl->tpl_vars['FBV_description']->value],$_smarty_tpl ]);
	} else {
	...
	<?php if ($_smarty_tpl->tpl_vars['FBV_listSection']->value) {?><ul class="checkbox_and_radiobutton"><?php }?>
		<?php if ($_smarty_tpl->tpl_vars['FBV_title']->value) {?><label <?php if ($_smarty_tpl->tpl_vars['FBV_labelFor']->value) {?> for="<?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ $_smarty_tpl->tpl_vars['FBV_labelFor']->value ]);?>
    ...
    echo $_smarty_tpl->tpl_vars['FBV_title']->value;
        ...
        if ($_from !== null) {
            foreach ($_from as $_smarty_tpl->tpl_vars['FBV_error']->value) {
                ...
                ?>
				<span class="error"><?php echo call_user_func_array($_smarty_tpl->registered_plugins['modifier']['escape'][0], [ $_smarty_tpl->tpl_vars['FBV_error']->value ]);?>
</span>
			<?php
            }
        }
