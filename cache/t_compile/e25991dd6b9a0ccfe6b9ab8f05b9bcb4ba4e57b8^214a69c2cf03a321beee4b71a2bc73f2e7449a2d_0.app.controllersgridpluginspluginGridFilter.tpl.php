<?php
/* Smarty version 4.5.5, created on 2026-01-14 10:31:34
  from 'app:controllersgridpluginspluginGridFilter.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, [
    'version' => '4.5.5',
    'unifunc' => 'content_69670e16ca77a5_34133420',
    ...
    function content_69670e16ca77a5_34133420(Smarty_Internal_Template $_smarty_tpl)
    {
        echo '<script'; ?>
>
...
<?php echo '</script'; ?>
>
<form class="pkp_form filter" id="pluginSearchForm" action="<?php echo call_user_func_array($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], [ ['router' => PKP\core\PKPApplication::ROUTE_COMPONENT,'op' => 'fetchGrid'],$_smarty_tpl ]);?>
" method="post">
	...
	<?php $_block_plugin1 = $_smarty_tpl->smarty->registered_plugins['block']['fbvFormArea'][0] ?? null;
		...
		<?php $_block_plugin2 = $_smarty_tpl->smarty->registered_plugins['block']['fbvFormSection'][0] ?? null;
			...
			<?php echo call_user_func_array($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], [ ['type' => 'text','id' => 'pluginName','value' => $_smarty_tpl->tpl_vars['filterSelectionData']->value['pluginName'],'size' => $_smarty_tpl->tpl_vars['fbvStyles']->value['size']['LARGE'],'inline' => true],$_smarty_tpl ]);?>
